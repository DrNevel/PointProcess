...
Features_RR=get_features_RR(fpth,'sel_EKGR',1,'fs',250,'PPorderMono',8,'get_PP',1,'UndSampl',20,'get_spectra',1);
...
Features_COV=get_features(fpth,'sel_EKGR',1,'fs',250,'PPorderBiva',8,'get_PP',1,'get_biva',1,'UndSampl',20,'get_spectra',1);
% Features_COV=get_features_copy(fpth,'sel_EKGR',1,'fs',250,'PPorderBiva',8,'get_PP',1,'get_biva',1,'UndSampl',20,'get_spectra',1);
% toc

% about 610 seconds
tic
Features_TRI=get_trifeatures(fpth,'sel_EKGR',1,'fs',250,'PPorderMulti',8,'get_PP',1,'get_multi',1,'UndSampl',20,'get_spectra',1,'cov_type','pat-syst','correct_diast',1);
