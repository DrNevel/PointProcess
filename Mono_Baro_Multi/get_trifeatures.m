function [Features,RR_correction,Coherences] = get_trifeatures(selected_wf, varargin)
...
% %     if 'annotations' has one line only, it is assumed to be the
% %     sequence of R peak times; with more lines, the others represent the
% %     specific indexes of events and their respective values.
% %     BUT WHICH IS THE CONVENTION FOLLOWED IN THE GIVEN 'annotations'?
% %     the one in get_features_RR or the one in here?
...
% % In this following section, the covariate is chosen (if not, it defaults
% % to use 'syst' as a covariate); specifically, covariates times and values
% % are imposed to COV_T and COV_V
...
if get_PointProcess
    ...
    if get_biva
        ...
        if get_spectra % this must be changed to consider also spectral analysis with triv. RR-BP-PAT
            if strcmp(cov_type,'syst')
% % most of the following spectral parameters (indipendently from them being
% % mono or biva) are just integrations of parametric spectra in specific
% % freq. bands
                % Baroreflex - PP
                if get_mono
...
%         [lbl,Features.PP.Cov.Baro.GAIN_21_LF,Features.PP.Cov.Baro.FS,...
%                         Features.PP.Cov.Baro.PHASE_21_LF,Features.PP.Cov.Baro.r_LF,...
%                         Features.PP.Cov.Baro.GAIN_12_LF,Features.PP.Cov.Baro.r_HF,...
%                         Features.PP.Cov.Baro.PHASE_12_LF,Features.PP.Cov.Baro.r_VLF,...
%                         Features.PP.Cov.Baro.GCI_21_LF,Features.PP.Cov.Baro.H11,...
%                         Features.PP.Cov.Baro.GCI_12_LF,Features.PP.Cov.Baro.H12,...
%                         Features.PP.Cov.Baro.COH_LF,Features.PP.Cov.Baro.COH_HF,Features.PP.Cov.Baro.H13,...
%                         Features.PP.Cov.Baro.F_HF,Features.PP.Cov.Baro.S_RR_TOT,Features.PP.Cov.Baro.H21,...
%                         Features.PP.Cov.Baro.S_RR_LF,Features.PP.Cov.Baro.H22,...
%                         Features.PP.Cov.Baro.S_BP_TOT,Features.PP.Cov.Baro.H23,...
%                         Features.PP.Cov.Baro.S_BP_LF,Features.PP.Cov.Baro.H31,...
%                         Features.PP.Cov.Baro.S_CR_TOT,Features.PP.Cov.Baro.S_CR_VLF,Features.PP.Cov.Baro.H32,...
%                         Features.PP.Cov.Baro.S_CR_HF,Features.PP.Cov.Baro.S_RR,Features.PP.Cov.Baro.H33,...
%                         Features.PP.Cov.Baro.S_CR,Features.PP.Cov.Baro.COH,Features.PP.Cov.Baro.S_RR,...
%                         Features.PP.Cov.Baro.PHASE_2to1,Features.PP.Cov.Baro.GAIN_1to2,Features.PP.Cov.Baro.S_BP,...
%                         Features.PP.Cov.Baro.FS,Features.PP.Cov.Baro.r_LF,Features.PP.Cov.Baro.S_PAT,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.S_CR12,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.S_CR13,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.S_CR23,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.S_CR12_conj,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.S_CR13_conj,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.S_CR23_conj,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.COH12,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.COH13,...
%                         Features.PP.Cov.Baro.GCI_2to1,Features.PP.Cov.Baro.COH23] = ...

                        [Features.PP.Cov.Baro.lbl,Features.PP.Cov.Baro.vouts] = ...
                        TriBaroShort(Features.PP.Cov.Thetap,Features.PP.Cov.Thetap2(:,:,:),PPorderMulti,...
                        Features.PP.Cov.s2,Features.PP.Cov.cov_s2(2,:),Features.PP.Cov.cov_s2(3,:),...
                        1./Features.PP.Cov.meanRR,fres,1,1:25);
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                                 END OF PP/BARO SECTION                                        %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% % maximum signal duration (last time of latest signal, minus first time
% % of earliest signal?)
