...
% %     generates parametric bivariate estimates for each batch (takes into
% %     account parametrically monovariate generated spectra [when given] of each covariate
% %     for better accuracy?) (outs_lbl = labels of 'out' values)
