function [outs_lbl,varargout] = Baro_vect_edit(RR_Theta,COV_Theta, ord, s2, cov_s2, fsamp, prec, ret)
...
for j = length(blk):-1:2
    ...
    [outs_lbl, out] = ...
            Baro(RR_Theta(:,bb),COV_Theta(:,bb), ord, s2(:,bb), cov_s2(:,bb), fsamp(:,bb), prec,ret);
            % s2_11 = s2
