...
%  chen-chu@163.com
%
% Chu Chen (2021). hurst parameter estimate (https://www.mathworks.com/matlabcentral/fileexchange/19148-hurst-parameter-estimate), MATLAB Central File Exchange. Retrieved January 5, 2021.
if nargin == 1
    isplot = 0;
end
...
if isplot ~= 0
    ...
    xlabel('Log10(Aggregate Level)'),ylabel('Log10(Curve Length)'),title('Higuchi Method');
end