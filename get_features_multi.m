function [Features,RR_correction,Coherences] = get_features_multi(selected_wf, varargin)
%%% valid for mono (both hrv_indices spectral estimation and MonoBAro
%%% spectral estimation), Biva, Triva
...
elseif strcmp(cov_type,'pat')
    COV_T = ONSET;
    COV_V = ONSET-EKGR;
elseif strcmp(cov_type,'pat-syst') % what we need for the trivariate model
    COV_T = [ONSET;SYST];
